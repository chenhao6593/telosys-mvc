...
public class HelloWorldController {
	...
	public String saveRegistration(@Valid AppUser user,
		...
		if(appUserEntity.getListOfUserProfile()!=null){
			for(UserProfileEntity profile : appUserEntity.getListOfUserProfile()){
